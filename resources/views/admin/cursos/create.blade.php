...
@section('content')
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <div class="btn-group">
          <a href="{{ url('cursos') }}" class="btn blue darken-4 text-white"><i class="fas fa-sort-alpha-down-alt"></i> Listado</a>         
          <a href="{{ url('cursos/create') }}" class="btn blue darken-4 text-white"><i class="fa fa-plus-square"></i> Ingresar</a>
        </div>
      </div>
    </div>
    <br>
      ...
      <div class="col-md-12">
        <div class="card">
         <div class="card-header  outline-primary blue-gradient-dark text-white">
              <h3 class="card-title">Agregar nuevo curso</h3>
             
            </div>
           {!!Form::open (['route'=>'cursos.store','id'=>'postulados_form'])!!}
            <div class="card-body">
              <ul class="list-inline">
                ...
                @include('admin.cursos.partials.nuevo')
            </div>
