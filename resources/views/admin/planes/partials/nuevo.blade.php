 <div class="form-group mt-4">
  <div class="form-group">
    ...
    {{ Form::text('nb_titulo', null, array('class' => 'form-control','placeholder'=>'Ingresa los datos')) }}
 </div>
</div>
<div class="form-group">
  {{ Form::label('nb_sub_titulo', 'Cuerpo') }}
  {{ Form::textarea('nb_sub_titulo', null, array('class' => 'form-control','placeholder'=>'Ingresa los datos requeridos')) }}
</div>
<div class="form-group">
