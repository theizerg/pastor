    ...
    @section('content')
     <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="btn-group">
                <a href="{{ url('somos/create') }}" class="btn text-white  blue darken-4 "><i class="fa fa-plus-square"></i> Ingresar</a>
                </div>
            </div>
            </div>
             @endcan
        ...
        <div class="card card-danger ">
          <div class="card-header blue-gradient-dark text-white outline-primary ">
              <h3 class="card-title">Listado de quiénes somos</h3>
          </div>
                <!-- /.card-header -->
                ...
                <table id="example" class="table table-striped" style="width:100%">
                    ...
                    <td><span class="badge fa-1x  elevation-2 text-white fa-1x {{ $encabezado->status_id ? 'green' : 'red' }}">{{ $encabezado->display_status }}</span></td>
                     <td>
                     <a class="btn btn-round blue darken-4" href="{{ url('somos', [$encabezado->encode_id,'edit']) }}"><i class="material-icons" style="color: white;">edit</i> </a>
                     </tr>
                    @endforeach
                    </tr>
                    </tbody>
