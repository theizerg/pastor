      ...
      <div class="col-md-12">
        <div class="card">
         <div class="card-header  outline-primary blue-gradient-dark text-white">
              <h3 class="card-title">Agregar nuevo grupo somos</h3>
             
            </div>
           {!!Form::open (['route'=>'somosCuadros.store','id'=>'postulados_form'])!!}
            <div class="card-body">
              <ul class="list-inline">
                   ...
                   <li class="list-inline-item">
                      <a href="/somosCuadros" class="link_ruta">
                        Listado &nbsp; &nbsp;<i class="fa fa-chevron-right" aria-hidden="true"></i>
                      </a>
                    </li>
                   <li class="list-inline-item">
                      <a href="/somosCuadros/create" class="link_ruta">
                        Nuevo
                      </a>
                    </li>
                  </ul><br>
